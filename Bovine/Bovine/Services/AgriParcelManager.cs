...
{
    public class AgriParcelManager
    {
        public async Task<IEnumerable<AgriParcel>> GetAll()
        {
            Uri uri = new Uri(string.Format(Constants.RestUrl, "?type=AgriParcel"));
            ...
            return JsonConvert.DeserializeObject<IEnumerable<AgriParcel>>(result);
        }
